...
public class TimerHighScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerHighScoreShop = (LinearLayout) findViewById(R.id.timerHighScore);
    ...
    /*
    onBackPressed is customed to take user to a specific activity, in this case TimerActivity
